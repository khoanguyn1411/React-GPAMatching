...
export namespace DateService {
   ...
   */
  export function toFormat(value: string | Date, type: "VN" | "US" | "API"): string {
    if (type === "US") {
   ...
   */
  export function compareWithToday(dateStr: string | Date): "in-past" | "in-future" | "today" {
  ...
  export function isValidDate(date: Date): boolean {
    dayjs.isDayjs;
    return (
      Object.prototype.toString.call(date) === "[object Date]" && !Number.isNaN(date.getTime())
    );
  }
}
