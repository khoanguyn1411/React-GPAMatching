...
import { RecordObject, StrictOmit } from "../types/common";
...
interface InputFormError<T extends RecordObject> {
...
function generateErrorsRecursive<T extends HttpError<RecordObject>>({
  ...
  Object.entries(errors).forEach(([key, value]) => {
    ...
    generateErrorsRecursive({
      errors: errors[key] as unknown as T,
...
export namespace FormService {
   ...
   */
  export function isDirtyFields<T extends RecordObject>(dirtyFields: T): boolean {
